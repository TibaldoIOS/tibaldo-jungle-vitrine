export const jungleLocalIdentity = {
  ...
  mapsUrl: "https://maps.app.goo.gl/KAuuHJf1BPGf4Wgw6?g_st=ic",
  latitude: 50.6251203,
  longitude: 3.0394823,
...
export function jungleStoreStructuredData() {
  ...
  return {
    ...
    geo: { "@type": "GeoCoordinates", latitude: identity.latitude, longitude: identity.longitude },
    hasMap: identity.mapsUrl,
    sameAs: [identity.instagramUrl, identity.facebookUrl],
    address: {
      "@type": "PostalAddress",
