...
export const openingEvent: JungleEvent = {
  ...
  videoUrl: null,
  seoTitle: "Ouverture boutique de plantes à Lille | Tibaldo Jungle",
  seoDescription: "Nouvelle boutique de plantes à Lille : inauguration gratuite de Tibaldo Jungle le 26 septembre 2026, avec plantes rares, conseils et rempotage.",
