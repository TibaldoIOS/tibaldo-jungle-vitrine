...
const verifiedMediaByRoute: Readonly<Record<string, readonly PlantImage[]>> = {
  ...
  "/plantes/anthurium/clarinervium": [image(
    ...
    1126,
    verifiedLicense(
      "Auteur non communiqué · fichier privé transmis par l’Owner",
      "Droits de réutilisation confirmés par l’Owner",
      "",
      "owner-provided://tibaldo/anthurium-clarinervium-2026-09-02",
      "Identité Anthurium clarinervium et droits confirmés par l’Owner le 2 septembre 2026. Adaptation locale : conversion WebP à 2000 px, sans recadrage ni transformation morphologique.",
    ),
  )],
