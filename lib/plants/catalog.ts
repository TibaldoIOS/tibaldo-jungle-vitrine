...
export const plants = [{
  ...
  gallery: [
    { src: "/alocasia-imperial-red.webp", alt: "Alocasia Imperial Red mature aux larges feuilles vertes et pétioles bordeaux", caption: "Interprétation éditoriale de l’Alocasia ‘Imperial Red’ — photographies du spécimen du Studio à venir.", width: 1024, height: 1536 },
  ...
  gallery: [{ src: "/pilea-peperomioides.webp", alt: "Pilea peperomioides mature aux feuilles rondes dans un pot en céramique", caption: "Interprétation éditoriale du Pilea peperomioides — photographies du spécimen du Studio à venir.", width: 1024, height: 1536 }, { src: "/pilea-peperomioides.webp", alt: "Feuillage rond et pelté du Pilea peperomioides", caption: "Les pétioles rejoignent le centre des feuilles rondes.", width: 1024, height: 1536 }, { src: "/pilea-peperomioides.webp", alt: "Pilea peperomioides avec rejets au pied", caption: "Les rejets permettent de multiplier facilement la plante.", width: 1024, height: 1536 }],
