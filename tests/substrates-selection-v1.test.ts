...
test("every source is traceable; no supplier photography, price, stock or runtime fetch", () => {
  ...
  assert.doesNotMatch(component, /fetch\(|useEffect|use client|<iframe|<img|<Image/);
