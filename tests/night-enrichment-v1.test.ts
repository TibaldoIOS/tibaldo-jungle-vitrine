...
test("four group heroes reuse only locally available, proven assets", () => {
  assert.deepEqual(Object.keys(verifiedGroupMediaByGenre).sort(), ["cactus", "epipremnum", "peperomia", "pilea"]);
