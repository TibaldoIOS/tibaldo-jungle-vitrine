...
const credits: readonly [string, string, string, string, string?][] = [
  ...
  ["Monstera deliciosa ‘Thai Constellation’", "Owner Tibaldo · photographie personnelle", "Droits de réutilisation confirmés par l’Owner · conversion WebP sans recadrage", "owner-provided://tibaldo/monstera-thai-constellation-2026-09-05"],
  ["Monstera deliciosa ‘Mint’", "Owner Tibaldo · photographie personnelle", "Droits de réutilisation confirmés par l’Owner · conversion WebP sans recadrage", "owner-provided://tibaldo/monstera-mint-2026-09-05"],
