...
const credits: readonly [string, string, string, string, string?][] = [
  ...
  ["Monstera deliciosa ‘Thai Constellation’", "Photo : TIBALDO", "Photographie botanique · conversion WebP sans recadrage", "owner-provided://tibaldo/monstera-thai-constellation-2026-09-05"],
  ["Monstera deliciosa ‘Mint’", "Photo : TIBALDO", "Photographie botanique · conversion WebP sans recadrage", "owner-provided://tibaldo/monstera-mint-2026-09-05"],
