...
const credits: readonly [string, string, string, string, string?][] = [
  ...
  ["Anthurium pallidiflorum", "Driftless Botanicals", "Utilisation avec l’accord de Driftless Botanicals · conversion WebP sans recadrage", "https://www.driftlessbotanicals.net/wp-content/uploads/2024/12/Anth-Pallidiflorum.jpeg"],
