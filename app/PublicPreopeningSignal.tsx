  ...
  return (
    <aside className="public-preopening-signal" aria-label="Pré-ouverture du Studio Végétal à Lille">
      <div className="shell public-preopening-signal-inner">
        ...
        <Link href="/evenements/ouverture-tibaldo-jungle-lille"><span className="preopening-full">Préparer l’ouverture</span><span className="preopening-compact">Ouverture à Lille · 26 septembre</span> <span aria-hidden="true">↗</span></Link>
      </div>
    </aside>
  );
}
