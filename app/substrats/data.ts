...
export type SubstrateProfile = {
  ...
  methods: Array<{ title: string; copy: string }>;
  suitableFor: string[];
  cautions: string[];
...
export const substrateProfiles: Record<string, SubstrateProfile> = {
  ...
  perlite: {
    ...
    intro: "Blanche, poreuse et presque sans poids, la perlite horticole ouvre les substrats compacts et favorise une meilleure circulation de l’air autour des racines.",
    role: "La perlite est une roche volcanique expansée utilisée comme composant de structure. Elle ne remplace ni le terreau ni la fertilisation : elle apporte surtout de la porosité, réduit le tassement et facilite l’écoulement de l’excès d’eau.",
    strengths: [{ title: "Aération", copy: "Ses grains créent des espaces dans le mélange et aident les racines à respirer." }, { title: "Drainage", copy: "Elle limite la compaction et accompagne l’eau vers les trous d’évacuation du pot." }, { title: "Légèreté", copy: "Elle allège les mélanges destinés aux grands pots et aux plantes d’intérieur." }],
    methods: [{ title: "Dans un mélange tropical", copy: "Incorporez-la progressivement à une base organique, puis ajustez selon la plante, la taille du pot et votre fréquence d’arrosage." }, { title: "Pour les boutures", copy: "Associée à un support retenant un peu d’humidité, elle maintient une texture légère favorable aux jeunes racines." }, { title: "Pour corriger un substrat compact", copy: "Elle peut améliorer un futur rempotage, mais ne répare pas à elle seule un pot sans drainage ou un arrosage excessif." }],
    suitableFor: ["Monstera", "Philodendron", "Alocasia", "Anthurium", "Pothos", "boutures et jeunes plants"],
    cautions: ["Humidifier légèrement avant manipulation pour limiter la poussière.", "Ne pas utiliser seule comme source de nutrition.", "Adapter la proportion au besoin réel en eau de la plante."],
    faq: [{ question: "À quoi sert la perlite dans un terreau ?", answer: "Elle augmente la porosité du mélange, limite son tassement et favorise l’aération ainsi que le drainage autour des racines." }, { question: "Peut-on mettre uniquement de la perlite dans un pot ?", answer: "Pour la culture classique d’une plante d’intérieur, elle s’utilise surtout comme composant d’un mélange. Employée seule, elle n’apporte pas la nutrition attendue d’un substrat complet." }, { question: "Où trouver de la perlite pour plantes à Lille ?", answer: "La perlite horticole est disponible au Studio Végétal Tibaldo Jungle, 3 place de l’Arbonnoise à Lille, avec des conseils de dosage adaptés à votre plante." }],
    seoDescription: "Perlite horticole disponible à Lille chez Tibaldo Jungle : usages, avantages, dosage, plantes adaptées et conseils pour un substrat drainant et aéré.",
  },
  vermiculite: {
    slug: "vermiculite", name: "Vermiculite horticole", shortName: "Vermiculite", status: "available", statusLabel: "Disponible au Studio",
    eyebrow: "Minéral rétenteur · Disponible à Lille", title: "La vermiculite,", accent: "une humidité plus régulière.",
    intro: "Feuilletée, dorée et très légère, la vermiculite absorbe une partie de l’eau du mélange puis la restitue progressivement aux racines.",
    role: "La vermiculite équilibre les substrats qui sèchent trop vite. Sa capacité de rétention la rend intéressante pour les semis, les jeunes plants et certaines plantes appréciant une humidité régulière, à condition de ne pas saturer un mélange déjà compact.",
    strengths: [{ title: "Réserve d’eau", copy: "Elle retient l’humidité et contribue à ralentir le dessèchement du substrat." }, { title: "Souplesse", copy: "Sa texture légère convient aux semis et aux racines fines ou récemment formées." }, { title: "Régularité", copy: "Elle aide à lisser les variations entre deux arrosages dans un mélange bien conçu." }],
    methods: [{ title: "Pour les semis", copy: "Une petite part dans le mélange aide à conserver une humidité plus stable pendant la germination." }, { title: "Pour les plantes sensibles au sec", copy: "Ajoutez-la avec mesure à une base aérée afin de retenir l’eau sans supprimer l’oxygénation." }, { title: "Dans un intérieur chaud", copy: "Elle peut compenser un séchage rapide, mais le dosage doit rester cohérent avec la lumière et la saison." }],
    suitableFor: ["Maranta", "Calathea", "fougères", "semis", "jeunes plants", "plantes à racines fines"],
    cautions: ["Réduire la proportion dans un mélange déjà très rétenteur.", "Toujours conserver un pot percé et une structure aérée.", "Ne pas confondre rétention régulière et substrat constamment détrempé."],
    faq: [{ question: "Quelle différence entre perlite et vermiculite ?", answer: "La perlite est surtout recherchée pour l’aération et le drainage, tandis que la vermiculite retient davantage l’eau et la restitue progressivement." }, { question: "La vermiculite convient-elle aux plantes tropicales ?", answer: "Oui, en proportion adaptée, notamment pour les plantes qui apprécient un substrat frais. Elle doit être associée à des composants plus structurants si le mélange risque de rester trop humide." }, { question: "Où acheter de la vermiculite à Lille ?", answer: "La vermiculite horticole est disponible chez Tibaldo Jungle à Lille, avec un conseil personnalisé selon la plante et le mélange envisagé." }],
    seoDescription: "Vermiculite horticole à Lille : comprendre sa rétention d’eau, ses usages pour semis et plantes tropicales, les dosages et les erreurs à éviter.",
  },
  "ecorce-de-pin": {
    slug: "ecorce-de-pin", name: "Écorce de pin horticole", shortName: "Écorce de pin", status: "soon", statusLabel: "Prochainement au Studio",
    eyebrow: "Structure organique · Bientôt à Lille", title: "L’écorce de pin,", accent: "une charpente pour les racines.",
    intro: "Calibrée pour l’usage horticole, l’écorce de pin forme des espaces durables dans le mélange et accompagne les racines épaisses des plantes tropicales.",
    role: "L’écorce ne sert pas seulement à décorer la surface d’un pot. Incorporée au substrat, elle donne du relief, améliore la circulation de l’air et ralentit le tassement. Sa granulométrie doit rester cohérente avec le diamètre du pot et la finesse des racines.",
    strengths: [{ title: "Structure", copy: "Les fragments maintiennent des passages d’air dans les mélanges organiques." }, { title: "Drainage durable", copy: "Elle aide le substrat à conserver une texture grossière plus longtemps." }, { title: "Racines épiphytes", copy: "Elle rappelle la matière ligneuse rencontrée par de nombreuses aracées et orchidées." }],
    methods: [{ title: "Dans un mélange pour aracées", copy: "Associez l’écorce à une base organique et à un composant minéral pour équilibrer réserve d’eau et oxygénation." }, { title: "Pour les orchidées", copy: "Une granulométrie adaptée peut constituer la base d’un mélange très aéré, selon l’espèce et le mode de culture." }, { title: "Pour les grands pots", copy: "Elle limite le tassement d’un volume important, sans dispenser d’un bon drainage ni d’un contrôle de l’arrosage." }],
    suitableFor: ["Anthurium", "Monstera", "Philodendron", "Hoya", "orchidées", "plantes épiphytes"],
    cautions: ["Choisir une écorce horticole non colorée et de granulométrie adaptée.", "Contrôler son évolution lors des rempotages car une matière organique se décompose.", "Ne pas créer une couche isolée au fond du pot : mieux vaut l’intégrer au mélange."],
    faq: [{ question: "Pourquoi ajouter de l’écorce de pin au substrat ?", answer: "Elle structure le mélange, crée des poches d’air et réduit le tassement autour des racines." }, { question: "Peut-on utiliser une écorce décorative ?", answer: "Il vaut mieux choisir une qualité horticole propre, non colorée et calibrée. Un paillage décoratif n’est pas automatiquement adapté à la culture en pot." }, { question: "Quand l’écorce de pin sera-t-elle disponible à Lille ?", answer: "Elle rejoindra prochainement la matériauthèque du Studio Végétal Tibaldo Jungle. La page sera mise à jour dès sa réception." }],
    seoDescription: "Écorce de pin horticole à Lille : avantages, usages pour Monstera, Anthurium et orchidées, granulométrie et conseils de mélange Tibaldo Jungle.",
  },
  "billes-argile": {
    slug: "billes-argile", name: "Billes d’argile expansée", shortName: "Billes d’argile", status: "soon", statusLabel: "Prochainement au Studio",
    eyebrow: "Granulés minéraux · Bientôt à Lille", title: "Les billes d’argile,", accent: "stables et réutilisables.",
    intro: "Robustes, lavables et poreuses, les billes d’argile trouvent leur place en culture semi-hydroponique, en plateau d’humidité ou comme composant d’aération.",
    role: "Les billes d’argile ne sont pas une solution magique contre l’excès d’eau. Dans un pot classique, une couche au fond ne remplace pas un trou d’évacuation. Leur intérêt dépend du système de culture : mélange, réserve séparée, cache-pot ou semi-hydroponie.",
    strengths: [{ title: "Stabilité", copy: "Elles conservent leur forme et peuvent être nettoyées puis réutilisées." }, { title: "Aération", copy: "Intégrées correctement, elles créent de grands espaces dans le volume de culture." }, { title: "Semi-hydro", copy: "Elles peuvent servir de support inerte dans un système avec gestion précise de l’eau et des nutriments." }],
    methods: [{ title: "En semi-hydroponie", copy: "La transition demande des racines adaptées, un rinçage soigneux et une fertilisation pensée pour un support inerte." }, { title: "En plateau d’humidité", copy: "Placez l’eau sous le niveau du pot afin que les racines ne restent pas immergées." }, { title: "Dans un mélange", copy: "Quelques granulés peuvent ouvrir la structure, mais leur gros calibre ne convient pas à toutes les racines." }],
    suitableFor: ["plantes adaptées à la semi-hydro", "grands sujets", "plateaux d’humidité", "cache-pots", "mélanges très structurés"],
    cautions: ["Rincer avant utilisation pour éliminer les poussières.", "Ne pas compter sur une couche de billes pour drainer un pot non percé.", "En semi-hydro, apporter une nutrition adaptée et surveiller les racines."],
    faq: [{ question: "Faut-il mettre des billes d’argile au fond du pot ?", answer: "Une couche au fond ne remplace pas un pot percé et peut créer une zone humide. Le choix dépend du contenant et du système de culture." }, { question: "Les billes d’argile sont-elles réutilisables ?", answer: "Oui, après nettoyage et désinfection adaptés à l’usage prévu." }, { question: "Quand seront-elles disponibles chez Tibaldo Jungle ?", answer: "Les billes d’argile sont prévues prochainement au Studio Végétal de Lille. Leur disponibilité sera confirmée sur cette page." }],
    seoDescription: "Billes d’argile à Lille : semi-hydroponie, drainage, usages réels et erreurs à éviter. Conseils pour plantes d’intérieur chez Tibaldo Jungle.",
  },
  "sphaigne-sechee": {
    slug: "sphaigne-sechee", name: "Sphaigne séchée compactée", shortName: "Sphaigne séchée", status: "soon", statusLabel: "Prochainement au Studio",
    eyebrow: "Fibre végétale · Bientôt à Lille", title: "La sphaigne séchée,", accent: "souple après réhydratation.",
    intro: "Proposée sèche et compactée, la sphaigne reprend du volume au contact de l’eau et offre un support à la fois humide et aéré pour la propagation et certaines racines délicates.",
    role: "La sphaigne séchée n’est pas de la sphaigne vivante. Elle doit être réhydratée, essorée sans être comprimée puis disposée de façon souple. Très rétentrice, elle demande une surveillance attentive pour éviter une humidité permanente sans circulation d’air.",
    strengths: [{ title: "Réhydratation", copy: "Une petite quantité compactée développe un volume important une fois humidifiée." }, { title: "Propagation", copy: "Sa texture entoure les nœuds et jeunes racines tout en conservant une humidité régulière." }, { title: "Souplesse", copy: "Elle convient aux marcottes, supports de boutures et habillages de tuteurs." }],
    methods: [{ title: "Pour une bouture", copy: "Réhydratez, essorez puis placez la fibre sans la tasser autour de la zone à enraciner." }, { title: "Pour un marcottage", copy: "Maintenez la sphaigne humide autour d’un nœud, avec une enveloppe permettant de surveiller la formation des racines." }, { title: "Pour un tuteur", copy: "Elle peut garnir un support destiné aux racines aériennes, à condition de maîtriser l’humidité et l’entretien." }],
    suitableFor: ["Anthurium", "Hoya", "orchidées", "boutures tropicales", "marcottes", "jeunes racines"],
    cautions: ["Réhydrater puis essorer avant emploi.", "Ne pas tasser : l’air doit continuer à circuler.", "Choisir une origine responsable et ne pas la confondre avec la sphaigne vivante."],
    faq: [{ question: "Comment utiliser une sphaigne séchée compactée ?", answer: "Faites-la tremper, laissez-la reprendre son volume, puis essorez-la doucement avant de l’utiliser sans la compacter." }, { question: "La sphaigne remplace-t-elle un engrais ?", answer: "Non. Elle sert surtout de support et de réserve d’humidité ; elle ne constitue pas une fertilisation complète." }, { question: "Quand trouver de la sphaigne séchée à Lille ?", answer: "La sphaigne séchée compactée arrivera prochainement chez Tibaldo Jungle. Sa disponibilité sera confirmée ici après réception." }],
    seoDescription: "Sphaigne séchée compactée à Lille : réhydratation, bouturage, marcottage, plantes adaptées et précautions d’usage par Tibaldo Jungle.",
  },
};
