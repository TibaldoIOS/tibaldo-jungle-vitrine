...
export default function FlowersOnOrderPage() {
  ...
  return <main className="editorial-page flowers-page"><ScrollReveal /><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(schema) }} />
    ...
    <nav className="shell flower-service-link" aria-label="Découvrir les offres florales" data-reveal><a href="/fleurs-mariage-lille">Fleurs coupées pour un mariage à Lille <span>↗</span></a><a href="/fleurs-evenement-lille">Fleurs coupées pour un événement à Lille <span>↗</span></a></nav>
