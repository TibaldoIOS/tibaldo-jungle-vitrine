...
export default async function Page({ params }: Props) {
  ...
  return <main className="editorial-page"><ScrollReveal />
    ...
    {genre !== "anthurium" && <><section className="genre-portrait shell" aria-labelledby="genre-portrait-title" data-reveal>
