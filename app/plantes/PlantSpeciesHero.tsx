    ...
    >
      ...
      <div className="shell plant-profile-hero-content">
        <nav className="plant-profile-breadcrumb" aria-label="Fil d’Ariane">
          ...
          <span>·</span>
          <Link href={`/plantes/${plant.genre}`}>{plant.genreLabel}</Link>
          <span>·</span>
          <strong>{plant.displayName}</strong>
        </nav>
        <p className="eyebrow">
          <span /> Encyclopédie végétale · {plant.genreLabel}
        </p>
        <h1>
          <ScientificName
        ...
        <p>{plant.subtitle}</p>
        <div className="plant-profile-hero-meta">
          <Link
