...
export default function Home() {
  return (
    <main>
      ...
      <aside className="opening-banner" aria-label="Information inauguration"><div className="shell opening-banner-inner"><span className="pulse" aria-hidden="true" /><p><strong>Ouverture le 26 septembre 2026 à Lille</strong><span aria-hidden="true">—</span> Rempotage offert pour l’inauguration</p></div></aside>
