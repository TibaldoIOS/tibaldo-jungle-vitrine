...
import styles from "./FinalGoldenGroup.module.css";
...
export default function FinalGoldenHubPilea() {
  ...
  return (
    <main className={`${golden.page} ${base.groupPage} editorial-page`} data-golden-group-v25-3="pilea">
      <ScrollReveal />
      <section className={styles.landscapeHero} aria-labelledby="v25-3-pilea-title">
        <SiteHeader />
        ...
        <div className={styles.forestFade} aria-hidden="true" />
        <div className={`${styles.heroContent} shell`}>
          <div className={styles.heroCopy}>
            <p className={styles.heroEyebrow}>Golden Group · Genre botanique</p>
            <h1 id="v25-3-pilea-title">Les <em>Pilea.</em></h1>
            <p className={styles.heroIntroduction} data-hero-editorial-copy>
            ...
            <p className={styles.heroNote}>Une planche éditoriale pour lire les formes et textures, pas un inventaire scientifique.</p>
          </div>
        </div>
      </section>

      <aside className={base.prototypeFlag} aria-label="Statut de cette page">
        <span>Lab V25.3</span><strong>Golden Group · art direction finale Owner</strong>
      </aside>
      ...
      <section className={`${golden.groupPassport} ${base.passport}`} aria-labelledby="v25-3-pilea-passport">
        <div className={`${golden.groupPassportHeading} shell`} data-reveal>
          <HubChapterMarker number="02" label="Passeport de culture" />
          <h2 id="v25-3-pilea-passport">Des repères communs.<br /><em>Des nuances selon l’espèce.</em></h2>
      ...
      <section className={`${golden.groupSpecies} ${base.groupSpecies}`} aria-labelledby="v25-3-pilea-species">
        <div className="shell"><HubChapterMarker number="03" label="Explorer le genre" /></div>
        <div id="v25-3-pilea-species"><GenusSpeciesCarousel genre="pilea" genusName="Pilea" plants={plants} /></div>
      ...
      <section className={`${golden.groupStory} ${base.groupStory}`} aria-labelledby="v25-3-pilea-story">
        <div className={`${golden.groupStoryHeading} shell`} data-reveal>
          <HubChapterMarker number="04" label="Histoire du groupe" />
          <h2 id="v25-3-pilea-story">Petites silhouettes.<br /><em>Grandes stratégies.</em></h2>
        </div>
      ...
      <section className={`${golden.groupDiagnostic} ${base.diagnostic} shell`} id="problemes" aria-labelledby="v25-3-pilea-diagnostic">
        <header data-reveal><HubChapterMarker number="05" label="Observer" /><h2 id="v25-3-pilea-diagnostic">Lire les signaux<br /><em>avant d’agir.</em></h2></header>
