...
export async function GET() {
  ...
  const entries: SitemapEntry[] = [
    ...
    ...["plantes", "fleurs", "substrats", "rempotage", "evenements", "services", "coulisses", "contact"].map((path, index) => ({
      path: `/${path}`,
      modified: "2026-08-07",
      frequency: "weekly" as const,
      priority: index === 1 ? 0.9 : 0.8,
    })),
    ...["boutique-plantes-lille", "rempotage-plantes-lille", "substrats-en-vrac-lille", "pots-cache-pots-lille", "fleurs-sur-commande-lille", "fleurs-mariage-lille", "fleurs-evenement-lille", "livraison-fleurs-coupees-lille", "livraison-plantes-lille", "bouquets-fleurs-livraison-lille", "mur-vegetal-naturel-lille", "sos-plantes", "conseils"].map((path) => ({ path: `/${path}`, modified: "2026-08-15", frequency: "weekly" as const, priority: 0.9 })),
