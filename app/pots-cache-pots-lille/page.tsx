...
export default function PotsPage() {
  ...
  return <main className="editorial-page pots-page">
    ...
    <section className="pots-service"><div className="shell"><div data-reveal><p className="section-kicker">Au Studio Végétal</p><h2>Le bon pot,<br /><em>au bon moment.</em></h2><p>Apportez votre plante : nous pouvons regarder les racines, mesurer la motte et vérifier si un changement de diamètre est réellement nécessaire.</p></div><div data-reveal><Link href="/rempotage-plantes-lille"><span>Service</span><strong>Bar à rempotage</strong><Arrow /></Link><Link href="/substrats"><span>Matières</span><strong>Choisir le substrat</strong><Arrow /></Link><Link href="/contact"><span>Adresse</span><strong>Venir au Studio</strong><Arrow /></Link></div></div></section>
